import { HeartbeatData, Heartbeat } from '../activity/core/Types';
import { handleMayBeInactive } from '../activity/storage/ActivityStorage';
import fs from 'fs';
...
describe('Activity Utilities', () => {
  describe('handleMayBeInactive', () => {
    test('sollte may_be_inactive zu inactive umwandeln wenn userActivity inactive ist', () => {
      ...
      // Vollständiges HeartbeatData-Objekt statt Partial
      const heartbeatData: HeartbeatData = { userActivity: 'inactive' };
    ...
    test('sollte keine Änderungen vornehmen wenn userActivity nicht inactive ist', () => {
      const currentTime = new Date('2024-03-20T10:05:00Z').getTime();
      const heartbeatData: HeartbeatData = { userActivity: 'active' };
